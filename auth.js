import { bootFinanceiroApp, getFinanceiroMenuState } from "./app.js?v=20260413am";

const IOS_APP_VERSION = "Versão atual: 1.32";
const IOS_SETTINGS_VERSION = "1.32";
const IOS_BUILD_TOKEN = "20260413am";
